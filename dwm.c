...
/* VANITYGAPS_PATCH MODIFICATED ERROR */
static const unsigned int gappih;       /* horiz inner gap between windows */
static const unsigned int gappiv;       /* vert inner gap between windows */
static const unsigned int gappoh;       /* horiz outer gap between windows and screen edge */
static const unsigned int gappov;       /* vert outer gap between windows and screen edge */

static const int smartgaps;        /* 1 means no outer gap when there is only one window */
...
manage(Window w, XWindowAttributes *wa)
{
	...
	/* PRESERVEONRESTART_PATCH MODIFICATED ERROR */
	{
		int format;
...
setup(void)
{
	...
	/* SYSTRAY_PATCH MODIFICATED ERROR */
