...
static const char *colors[][3]      = {
	/*               fg         bg         border   */
	[SchemeNorm] = { col_gray3, col_panel, col_border_idle },
	[SchemeSel]  = { col_gray4, col_cyan,  col_border_act  },
};


/* TAGS */
static const char *tags[] = { "m", "b", "t", "4", "5", "6", "7", "8", "9" };
...
static const int refreshrate = 500;  /* refresh rate (per second) for client move/resize */
